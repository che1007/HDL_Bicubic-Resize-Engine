`timescale 1ns/10ps
`define CYCLE_TIME      52.2  
`define MAX_CYCLE_PER_PATTERN  150000
`define PLOT_IMG
// `define USECOLOR  

// quartus
`define input_image     "../../input_image.rcf"  
...
initial begin
    for(i=0;i<pat_number;i=i+1) begin
        ...
        if (fd == 0) begin
			...
			$readmemb(`input_image , input_RAM.memory );
